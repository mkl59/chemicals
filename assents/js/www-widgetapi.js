...
var Ja=/#|$/;function Ka(a,b){var c=m("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfl9bgVTV/yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=[],c="ERRORS"in C?C.ERRORS:c,c.push([a,b,void 0,void 0,void 0]),Aa("ERRORS",c))}
...
Z.prototype.l=function(a,b){Z.D.l.call(this,a,b?b.info:void 0)};u("YT.PlayerState.UNSTARTED",-1);u("YT.PlayerState.ENDED",0);u("YT.PlayerState.PLAYING",1);u("YT.PlayerState.PAUSED",2);u("YT.PlayerState.BUFFERING",3);u("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfl9bgVTV/YT.PlayerState.CUED",5);u("YT.UploadWidgetEvent.API_READY","onApiReady");u("YT.UploadWidgetEvent.UPLOAD_SUCCESS","onUploadSuccess");u("YT.UploadWidgetEvent.PROCESSING_COMPLETE","onProcessingComplete");u("YT.UploadWidgetEvent.STATE_CHANGE","onStateChange");u("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfl9bgVTV/YT.UploadWidgetState.IDLE",0);u("YT.UploadWidgetState.PENDING",1);
u("YT.UploadWidgetState.ERROR",2);u("YT.UploadWidgetState.PLAYBACK",3);u("YT.UploadWidgetState.RECORDING",4);u("YT.UploadWidgetState.STOPPED",5);u("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfl9bgVTV/YT.get",function(a){return Q[a]});
u("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfl9bgVTV/YT.scan",vb);u("YT.subscribe",function(a,b,c){O.subscribe(a,b,c);ub[a]=!0;for(var d in Q)Gb(Q[d],a)});
